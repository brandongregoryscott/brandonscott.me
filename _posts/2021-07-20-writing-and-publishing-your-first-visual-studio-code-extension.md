...
![Screenshot of the interactive prompt that Yeoman opens with](/assets/uploads/yeoman-prompt.png)
...
![Example configuration/output from Yeoman](/assets/uploads/yeoman-configuration.png)
...
![Screenshot of the ‘Run and Debug’ panel in VS Code](/assets/uploads/vscode-debug-panel.png)
...
![Command palette filtered down by “hello”](/assets/uploads/vscode-command-palette.png)

Command palette filtered down by “hello”

![Informational toast by running the default ‘Hello World’ command](/assets/uploads/vscode-informational-toast.png)
...
![Restart the development instance of VS Code to ensure your extension’s latest code is running](/assets/uploads/vscode-restart-debugger.png)
...
![An example of commands grouped by ‘kazoo’ in the Command Palette](/assets/uploads/vscode-command-palette-group.png)
...
![Example of the settings panel for kazoo](/assets/uploads/vscode-settings.png)
...
![Access your organization’s settings menu and navigate to the Personal access tokens page](/assets/uploads/azure-devops-personal-access-tokens-menu.png)

Access your organization’s settings menu and navigate to the Personal access tokens page

![Create a new personal access token for publishing](/assets/uploads/azure-devops-personal-access-token-modal.png)
...
![Create a new publisher for the Visual Studio Marketplace](/assets/uploads/vs-marketplace-new-publisher.png)
